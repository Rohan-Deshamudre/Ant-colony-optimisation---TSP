...
class Coordinate:
    ...
    # Returns the direction from self to given coordinate
    def coordinate_to_dir(self, coordinate):
        # This is difference between current position and previous position
        direction_coordinate = self.subtract_coordinate(coordinate)

        if direction_coordinate.get_x() == 1 and direction_coordinate.get_y() == 0:
            return Direction.west
        elif direction_coordinate.get_x() == -1 and direction_coordinate.get_y() == 0:
            return Direction.east
        elif direction_coordinate.get_x() == 0 and direction_coordinate.get_y() == -1:
            return Direction.south
        elif direction_coordinate.get_x() == 0 and direction_coordinate.get_y() == 1:
            return Direction.north
        else:
            print("wrong step",str(direction_coordinate.get_x()), ", y: ", str(direction_coordinate.get_y()))
            return None